...
@Component({
  selector: 'app-kupac-azuriranje-profil',
  templateUrl: './kupac-azuriranje-profil.component.html',
  styleUrls: ['./kupac-azuriranje-profil.component.css']
})
export class KupacAzuriranjeProfilComponent implements OnInit {
