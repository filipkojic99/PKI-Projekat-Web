...
@Component({
  selector: 'app-kupac-kolaci',
  templateUrl: './kupac-kolaci.component.html',
  styleUrls: ['./kupac-kolaci.component.css']
})
export class KupacKolaciComponent implements OnInit {
