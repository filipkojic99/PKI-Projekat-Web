...
@Component({
  selector: 'app-zaposleni-torte',
  templateUrl: './zaposleni-torte.component.html',
  styleUrls: ['./zaposleni-torte.component.css']
})
export class ZaposleniTorteComponent implements OnInit {
