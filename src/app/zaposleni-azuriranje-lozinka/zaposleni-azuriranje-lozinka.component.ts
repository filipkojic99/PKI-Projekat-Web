...
@Component({
  selector: 'app-zaposleni-azuriranje-lozinka',
  templateUrl: './zaposleni-azuriranje-lozinka.component.html',
  styleUrls: ['./zaposleni-azuriranje-lozinka.component.css']
})
export class ZaposleniAzuriranjeLozinkaComponent implements OnInit {
